...
class Parameters:
    def __init__(self):
        self.CLASSES = open("D:/Human-Activity-Recognition-ResNets/model/action_recognition_kinetics.txt"
                            ).read().strip().split("\n")
        self.ACTION_RESNET = 'D:/Human-Activity-Recognition-ResNets/model/resnet-34_kinetics.onnx'
#         self.VIDEO_PATH = None
        self.VIDEO_PATH = "D:/Human-Activity-Recognition-ResNets/Test/crying.mp4"
...
# A Double ended queue to store our frames captured and with timeq
# old frames will pop
# out of the deque
